...
function Sr(e, t, n, r, l) {
  ...
  if (((o = 0), (r = r === "" ? "." : r + ":"), Ao(e)))
    ...
    for (e = s.call(e), u = 0; !(i = e.next()).done; )
      (i = i.value), (s = r + wl(i, u++)), (o += Sr(i, t, n, s, l));
  else if (i === "object")
    throw (
      ((t = String(e)),
      Error(
      ...
      e: for (var H = 0, Y = C.length, er = Y >>> 1; H < er; ) {
        ...
        if (0 > l(Sl, z))
          yt < Y && 0 > l(tr, Sl)
            ? ((C[H] = tr), (C[yt] = z), (H = yt))
            : ((C[H] = Sl), (C[vt] = z), (H = vt));
        else if (yt < Y && 0 > l(tr, z)) (C[H] = tr), (C[yt] = z), (H = yt);
        else break e;
      }
    }
    return P;
      ...
      return (
        ...
        z > H
          ? ((C.sortIndex = z),
            ...
            n(s) === null &&
              C === n(c) &&
              (w ? (f(N), (N = -1)) : (w = !0), gl(v, z - H)))
          : ((C.sortIndex = Y), t(s, C), S || g || ((S = !0), yl(E))),
        C
      );
    }),
...
if (Qe) {
  ...
  Gs = Tl && (!document.documentMode || 9 < document.documentMode);
}
function ou() {
        ...
        for (var a = c, d; a !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              v !== null &&
              ((d = v),
              f !== null && ((v = jn(a, f)), v != null && w.push(Vn(a, v, d)))),
            O)
          )
            break;
          a = a.return;
...
function aa(e, t, n) {
  (we[ke++] = Be), (we[ke++] = He), (we[ke++] = Pt), (Pt = e);
  var r = Be;
  e = He;
  var l = 32 - Re(r) - 1;
  (r &= ~(1 << l)), (n += 1);
...
function $l(e) {
  ...
  if (((e = n.interleaved), e !== null)) {
    l = e;
    do (i = l.lane), (U.lanes |= i), (Tt |= i), (l = l.next);
    while (l !== e);
...
function La(e, t, n) {
  return (
    (n = n != null ? n.concat([e]) : null), al(4, 4, Ta.bind(null, t, e), n)
  );
}
function ko() {}
function Ia(e, t) {
...
function Oa(e, t, n) {
  return zt & 21
    ? (je(n, t) || ((n = Fs()), (U.lanes |= n), (Tt |= n), (e.baseState = !0)),
      t)
...
function fd(e, t, n) {
  ...
  if (Ma(e)) Fa(t, l);
    ...
    (n = da(e, t, l, r)),
      n !== null && ((l = oe()), Oe(n, e, r, l), Da(n, t, r));
  }
}
function Ma(e) {
  var t = e.alternate;
  ...
  return (
    ...
    e !== null && !ce
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ye(e, t, l))
      : (D && n && io(t), (t.flags |= 1), ie(e, t, r, l), t.child)
  );
}
  ...
  return (
    ...
    e !== null && !ce
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ye(e, t, l))
      : (D && r && io(t), (t.flags |= 1), ie(e, t, n, l), t.child)
  );
}
function Ru(e, t, n, r, l) {
  ...
  if ((Zt(t, l), t.stateNode === null))
    ...
    u !== h || p !== S || fe.current || qe
      ? (typeof g == "function" && (Ci(t, n, g, r), (S = t.memoizedState)),
        (c = qe || Eu(t, n, c, r, p, S, s) || !1)
          ? (m ||
...
function ec(e, t) {
  if (((zr = -1), (Tr = 0), I & 6)) throw Error(y(327));
  var n = e.callbackNode;
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            ...
            e.timeoutHandle = yi(St.bind(null, e, ae, $e), t);
            break;
          }
          St(e, ae, $e);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = yi(St.bind(null, e, ae, $e), r);
            break;
          }
          St(e, ae, $e);
          break;
...
function zo() {
  (X === 0 || X === 3 || X === 2) && (X = 4),
    Z === null || (!(Tt & 268435455) && !(fl & 268435455)) || et(Z, q);
}
function br(e, t) {
  var n = I;
  I |= 2;
...
function St(e, t, n) {
  var r = R,
    l = Ce.transition;
  try {
    (Ce.transition = null), (R = 1), zd(e, t, n, r);
  } finally {
    (Ce.transition = l), (R = r);
  }
  return null;
      ...
      return (
        ...
        l.$$typeof === void 0
          ? ((t.tag = 1),
            ...
            _i(t, r, e, n),
            (t = Pi(null, t, r, !0, i, n)))
          : ((t.tag = 0), D && i && io(t), ie(null, t, l, n), (t = t.child)),
        t
      );
    case 16:
      r = t.elementType;
...
var qu = (function () {
  function e(t) {
    ...
    (this.confettiSpeed = { x: m, y: m }),
      (this.finalConfettiSpeedX = ze(Zd, Jd, 3)),
      (this.rotationSpeed = o.length ? 0.01 : ze(qd, bd, 3) * Ju(s)),
      (this.dragForceCoefficient = ze(Hd, Wd, 6)),
      (this.radius = { x: l, y: l }),
      (this.initialRadius = l),
      (this.rotationAngle = r === "left" ? ze(0, 0.2, 3) : ze(-0.2, 0, 3)),
      (this.emojiSize = u),
      (this.emojiRotationAngle = ze(0, 2 * Math.PI)),
      (this.radiusYUpdateDirection = "down");
    var h =
      r === "left"
        ? (ze(Zu, Gu) * Math.PI) / 180
        : (ze(-Gu, -Zu) * Math.PI) / 180;
      ...
      Mo(e, [
        ...
        },
        {
          ...
          value: function () {
            ...
            return (
              this.activeConfettiBatches.push(w),
              this.queueAnimationFrameIfNeeded(),
              w.getBatchCompletePromise()
            );
          },
        },
        {
...
function ap() {
  const [e, t] = wt.useState(!1),
    ...
    s = new sp(),
    c = () => {
      const p = new Audio("cancioncita.mp3");
      (p.loop = !0), p.play(), t(!0);
    },
    m = [
      {
      ...
      },
      {
        ...
        img: "https://i.pinimg.com/originals/39/6e/b4/396eb46880c16b496a94b0805cdae0fe.gif",
      },
      {
        id: 4,
    ...
    h = () => {
      let p = Math.floor(Math.random() * m.length);
      o <= 500 && u(o + 10), i(m[p]);
    };
  return le.jsx("main", {
    className:
    ...
    children: e
            ...
            ? le.jsxs("div", {
                ...
                children: [
                  le.jsx("h1", {
                    ...
                    children: "¡Sabía que dirías que sí! ❤️",
                  }),
                  le.jsx("img", {
            ...
            : le.jsxs(le.Fragment, {
                children: [
                  le.jsx("h1", {
                    ...
                    children: "¿Quieres ser mi San Valentín?",
                  }),
                  le.jsx("img", {
                    src:
                      l.img ||
                  ...
                  le.jsxs("div", {
                    className: "grid grid-cols-1 md:grid-cols-2 mt-10 gap-5",
                    children: [
                      le.jsx("button", {
                        onClick: () => {
                          r(!0),
                        ...
                        className:
                          "bg-green-500 text-white font-bold p-2 rounded-md text-xl",
                        style: { height: o },
                        children: "Si",
                      }),
                      le.jsx("button", {
      ...
      : le.jsx("button", {
          onClick: c,
          className:
            "bg-pink-500 text-white font-bold px-6 py-3 rounded-lg text-2xl",
          children: "💖 Empezar 💖",
        }),
  });
}
Kl.createRoot(document.getElementById("root")).render(
  le.jsx(Tc.StrictMode, { children: le.jsx(ap, {}) })
);
